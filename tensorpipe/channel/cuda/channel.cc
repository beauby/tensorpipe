...
#include <tensorpipe/proto/channel/cuda.pb.h>
...
void Channel::Impl::recvFromLoop_(
  ...
  cudaIpcMemHandle_t* remoteHandle = reinterpret_cast<cudaIpcMemHandle_t*>(
      const_cast<char*>(pbDescriptor.handle().c_str()));
