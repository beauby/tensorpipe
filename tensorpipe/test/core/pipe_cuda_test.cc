...
class CudaSimpleWriteReadTest : public ClientServerPipeTestCase {
...
TEST(Pipe, CudaSimpleWriteRead) {
  CudaSimpleWriteReadTest test;
  test.run();
}
...
class CudaSimpleWriteReadOnCudaWithoutTargetDeviceTest
    : public ClientServerPipeTestCase {
  InlineMessage imessage_ = {
      .payloads =
          {
...
TEST(Pipe, CudaSimpleWriteReadOnCudaWithoutTargetDevice) {
  CudaSimpleWriteReadOnCudaWithoutTargetDeviceTest test;
  test.run();
}
